...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   [0] = LAYOUT(
      ...
      KC_LSFT  ,  KC_Z     ,  KC_X     ,  KC_C     ,  KC_V     ,  KC_B     ,  KC_NO    ,        KC_NO    ,  KC_N     ,  KC_M     ,  KC_COMM  ,  KC_DOT   ,  CTL_T(KC_SLSH)  ,  KC_RSFT  ,
      KC_GRV   ,  KC_QUOT  ,  KC_LSFT  ,  KC_LEFT  ,  KC_RGHT  ,                                                        KC_UP    ,  KC_DOWN  ,  KC_LBRC  ,  KC_RBRC  ,  KC_N     ,
